...
//		addWidget(startLabel);
		...
		startLabe3.setColor(Color.BLUE);
		...
		startLabe4.setColor(Color.BLUE);
		...
		startLabe5.setColor(Color.BLUE);
		startLabe5.setString("ごめんねぇ、僕のせいで無駄な作業させちゃって by新田");
		startLabe5.setRelativePosition(0.05f, 0.65f);
		Font f5 = new Font("", Font.PLAIN, 18);
		startLabe5.setFont(f5);
		addWidget(startLabe5);
		
		RWTImage image = new RWTImage("data\\images\\regameover.jpg");
